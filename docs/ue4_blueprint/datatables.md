...
**Data Tables** são estruturas de dados com vários tipos de variáveis agrupados podem ser utilizadas para armazenamento de forma estática informações dos personagens e suas características, recursos do jogo como espadas, escudos, magias e propriedades do jogo como níveis, dificuldades e pontuação.
