...
![Classes de atores](../imagens/actor/actor1.jpg)

<a name="21"></a>
### 2.1 Actor
Objeto básico que pode ser adicionado a o mundo.  
![Classe Actor](../imagens/actor/actor2.jpg)  
...
![Posição](../imagens/actor/actor4.jpg)
...
![Posição Relativa](../imagens/actor/actor5.jpg)
...
![Componentes](../imagens/actor/actor6.jpg)

<a name="72"></a>
### 7.2 Herança de propriedades e métodos.  
![Herança](../imagens/actor/actor10.jpg)

<a name="73"></a>
### 7.3 Referências de atores e componentes.  
![Herança](../imagens/actor/actor11.jpg)
...
![Herança](../imagens/actor/actor12.jpg)
...
![Herança](../imagens/actor/actor13.jpg)

<a name="83"></a>
### 8.3 Listando Actors utilizando *tag* (etiquetas)  
![Herança](../imagens/actor/actor14.jpg)
