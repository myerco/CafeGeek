...
&nbsp;&nbsp;[10.6 O que é Animação 2D?](#10.6)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.1 Como o Unreal Engine trabalha com animação 2D?](#10.6.1)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.2 Preparado os Sprites do projeto](#10.6.2)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.3 Agrupando sprites em Tile Sets](#10.6.3)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.4. Implementando uma cena utilizando Tile Map](#10.6.4)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.5 Criando sequencias de animação utilizando Flipbooks](#10.6.5)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.6 Adicionando e configurando o personagem do tipo PaperCharacter](#10.6.6)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.7 Implementando a lógica de animação do personagem do tipo PaperCharacter](#10.6.7)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[10.6.8 Implementando o canhão](#10.6.8)

<a name="10.6"></a>
## 10.6 O que é Animação 2D?
...
<a name="10.6.1"></a>
### 10.6.1 Como o Unreal Engine trabalha com animação 2D?
...
<a name="10.6.2"></a>
### 10.6.2 Preparado os Sprites do projeto
...
<a name="10.6.3"></a>
### 10.6.3 Agrupando sprites em Tile Sets
...
<a name="10.6.4"></a>
### 10.6.4 Implementando uma cena utilizando Tile Map
...
<a name="10.6.5"></a>
### 10.6.5 Criando sequencias de animação utlizado Flipbooks
...
<a name="10.6.6"></a>
### 10.6.6 Adicionando e configurando o personagem do tipo PaperCharacter
...
<a name="10.6.7"></a>
### 10.6.7 Implementando a lógica de animação do personagem do tipo PaperCharacter
...
2. Implementar o **BP_Cannon** do tipo `Actor`;
...
4. Lógica para localizar o personagem e movimentar o canhão na direção do player;
...
5. Lógica para disparar as balas `PB_FireBullet`;
...
6. Quanto o player colide com a área de detecção do canhão as variáveis **Look** e **Fire** são atualizadas para `True`, informando que o player foi detectado e o canhão pode disparar. Devemos adicionar uma `tag` no player para facilitar o seu reconhecimento;              
...
7. Quando o player sai da área de detecção as variáveis de controle são atualizadas para `false`;    
