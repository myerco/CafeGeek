...
- [CAPÍTULO 1 - A computação gráfica](#capítulo-1---a-computação-gráfica)
  - [O que é computação gráfica?](#o-que-é-computação-gráfica)
  - [Computação gráfica para jogos digitais](#computação-gráfica-para-jogos-digitais)
  - [O curso de Computação Gráfica](#o-curso-de-computação-gráfica)
    - [Habilidades que serão aprendidas](#habilidades-que-serão-aprendidas)
- [CAPÍTULO 2 - Como são formados os objetos 3D](#capítulo-2---como-são-formados-os-objetos-3d)
  - [Quais são os elementos que compõem imagens?](#quais-são-os-elementos-que-compõem-imagens)
  - [Arquivo Bitmap](#arquivo-bitmap)
  - [Vector Graphics](#vector-graphics)
  - [Lista de formatos que o Unreal Engine suporta](#lista-de-formatos-que-o-unreal-engine-suporta)
  - [O que são Pontos?](#o-que-são-pontos)
  - [Pixel](#pixel)
  - [Bits por pixel](#bits-por-pixel)
  - [Uma dica para utilizar texturas no Unreal Engine](#uma-dica-para-utilizar-texturas-no-unreal-engine)
  - [Linhas, raios e segmentos](#linhas-raios-e-segmentos)
  - [Planos e Triângulos](#planos-e-triângulos)
  - [Polígonos (Polygon)](#polígonos-polygon)
  - [Polígonos no Maya](#polígonos-no-maya)
  - [Polígonos no Unreal Engine](#polígonos-no-unreal-engine)
  - [Face](#face)
  - [Faces no Maya](#faces-no-maya)
  - [Faces no Unreal Engine](#faces-no-unreal-engine)
  - [Aresta](#aresta)
    - [Arestas no Maya](#arestas-no-maya)
    - [Arestas no Unreal Engine](#arestas-no-unreal-engine)
  - [Vértices](#vértices)
    - [Vértices no Maya](#vértices-no-maya)
    - [Vértices no Unreal Engine](#vértices-no-unreal-engine)
  - [Valores de ponto flutuante](#valores-de-ponto-flutuante)
  - [Sistemas de coordenadas](#sistemas-de-coordenadas)
  - [À esquerda e à direita serão entregues de coordenadas](#à-esquerda-e-à-direita-serão-entregues-de-coordenadas)
  - [Pivot - O centro do objeto 3D no Maya](#pivot---o-centro-do-objeto-3d-no-maya)
  - [Pivot - O centro do objeto 3D no Unreal Engine](#pivot---o-centro-do-objeto-3d-no-unreal-engine)
  - [Cor](#cor)
  - [Transparência com Alpha](#transparência-com-alpha)
- [CAPÍTULO 3 - Entendendo o processo de rendenrização](#capítulo-3---entendendo-o-processo-de-rendenrização)
  - [Entendendo como os processos são executados pelo sistema operacional](#entendendo-como-os-processos-são-executados-pelo-sistema-operacional)
  - [O processo de renderização pela GPU](#o-processo-de-renderização-pela-gpu)
  - [Aplicação](#aplicação)
  - [Geometria](#geometria)
  - [Renderização](#renderização)
  - [Conclusão](#conclusão)
- [CAPÍTULO 4 - Processamento de imagens com Unreal Engine](#capítulo-4---processamento-de-imagens-com-unreal-engine)
  - [O processo de renderização no Unreal Engine](#o-processo-de-renderização-no-unreal-engine)
  - [Processamento do Frame 0 - Time 0 - CPU](#processamento-do-frame-0---time-0---cpu)
  - [Processamento do Frame 1 - Time 33ms - Preparar a Thread](#processamento-do-frame-1---time-33ms---preparar-a-thread)
  - [Distance Culling ou corte de distância](#distance-culling-ou-corte-de-distância)
    - [Atores na cena](#atores-na-cena)
    - [Exemplo de atores na cena](#exemplo-de-atores-na-cena)
    - [Cull Distance Volume](#cull-distance-volume)
    - [Exemplo de código](#exemplo-de-código)
  - [Frustum Culling ou corte de câmera](#frustum-culling-ou-corte-de-câmera)
  - [Precomputed Visibility - Visibilidade pré-computada](#precomputed-visibility---visibilidade-pré-computada)
  - [Occlusion Culling](#occlusion-culling)
  - [Exemplo Occlusuion Culling](#exemplo-occlusuion-culling)
  - [Occlusion Culling é um processo pesado a partir de 10.000 objetos na cena](#occlusion-culling-é-um-processo-pesado-a-partir-de-10000-objetos-na-cena)
    - [Performance](#performance)
    - [Resultado](#resultado)
  - [Processamento do Frame 2 - Time 66ms - GPU](#processamento-do-frame-2---time-66ms---gpu)
  - [Drawcalls](#drawcalls)
  - [Comando Stat RHI](#comando-stat-rhi)
    - [Comando do console](#comando-do-console)
  - [O comando Stat unit e Stat FPS](#o-comando-stat-unit-e-stat-fps)
    - [Comandos do console FPS](#comandos-do-console-fps)
  - [Considerações](#considerações)
- [ATIVIDADES](#atividades)
  - [Renderização de materiais](#renderização-de-materiais)
...
### Computação gráfica para jogos digitais
...
### Quais são os elementos que compõem imagens?
...
### Lista de formatos que o Unreal Engine suporta
...
{% include image.html
    ...
    caption="Figura: Plano cartesiano - <https://conhecimentocientifico.r7.com>."
%}
...
{% include image.html
    ...
    alt="Figura: Figura pixelada livre."
    caption="Figura: Figura pixelada livre."
%}
...
### Uma dica para utilizar texturas no Unreal Engine
...
### Pivot - O centro do objeto 3D no Maya
...
### Entendendo como os processos são executados pelo sistema operacional
...
### O processo de renderização pela GPU
...
### O processo de renderização no Unreal Engine
...
### Processamento do Frame 0 - Time 0 - CPU
...
### Processamento do Frame 1 - Time 33ms - Preparar a Thread
...
### Distance Culling ou corte de distância
...
### Frustum Culling ou corte de câmera
...
### Processamento do Frame 2 - Time 66ms - GPU
...
### O comando Stat unit e Stat FPS
