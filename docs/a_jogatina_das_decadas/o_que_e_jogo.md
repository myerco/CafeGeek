...
1. [O que é um jogo?](#2)
1. [Homo Ludens](#3)    
1. [A Tensão como um elemento do jogo](#4)        
1. [A função do jogo](#5)            
...
Em 1998, a Nokia lançou modelos que chegavam  com três jogos pré-instalados: Memory, Snake e Logic.
