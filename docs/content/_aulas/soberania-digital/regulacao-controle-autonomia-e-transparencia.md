...
1. **Direito (O que é proibido fazer)**: Envolve a proteção de propriedade intelectual dos modelos de IA, regulação de plataformas digitais e direitos sobre a vida ("on life")
2. **Ética (O que deve ser feito)**: Foca no combate aos vieses digitais, na transparência algorítmica e no design ético ("ethics by design")
3. **Tecnologia (O que pode ser feito)**: Desenvolvimento de ferramentas para tornar a IA interpretável e responsabilizável
